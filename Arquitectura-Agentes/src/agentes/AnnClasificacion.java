 ...
 */
public class AnnClasificacion extends Agent{
    @Override
    ...
    class Comportamiento extends Behaviour{
        ...
        public void action() {
            ...
            try {
                ...
                String cmd = "python src/python/clasificacionModel.py " + paramentros;
                ...
                Mensajes.enviar(ACLMessage.INFORM, "Ag3", prediccion, "CODAC-3", getAgent());
            } catch (IOException e) {
